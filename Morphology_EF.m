...
for i = 1:N_steps
   ...
   site_1 = a.site(x_1+1,y_1,z_1)+a.site(x_1-1,y_1,z_1)+a.site(x_1,y_1+1,z_1)+a.site(x_1,y_1-1,z_1)+a.site(x_1,y_1,z_1+1)+a.site(x_1,y_1,z_1-1)+(a.site(x_1+1,y_1+1,z_1)+a.site(x_1+1,y_1-1,z_1)+a.site(x_1-1,y_1+1,z_1)+a.site(x_1-1,y_1-1,z_1)+a.site(x_1+1,y_1,z_1+1)+a.site(x_1+1,y_1,z_1-1)+a.site(x_1-1,y_1,z_1+1)+a.site(x_1-1,y_1,z_1-1)+a.site(x_1,y_1+1,z_1+1)+a.site(x_1,y_1+1,z_1-1)+a.site(x_1,y_1-1,z_1+1)+a.site(x_1,y_1-1,z_1-1))./sqrt(2);
   ...
   site_2 = a.site(x_2+1,y_2,z_2)+a.site(x_2-1,y_2,z_2)+a.site(x_2,y_2+1,z_2)+a.site(x_2,y_2-1,z_2)+a.site(x_2,y_2,z_2+1)+a.site(x_2,y_2,z_2-1)+(a.site(x_2+1,y_2+1,z_2)+a.site(x_2+1,y_2-1,z_2)+a.site(x_2-1,y_2+1,z_2)+a.site(x_2-1,y_2-1,z_2)+a.site(x_2+1,y_2,z_2+1)+a.site(x_2+1,y_2,z_2-1)+a.site(x_2-1,y_2,z_2+1)+a.site(x_2-1,y_2,z_2-1)+a.site(x_2,y_2+1,z_2+1)+a.site(x_2,y_2+1,z_2-1)+a.site(x_2,y_2-1,z_2+1)+a.site(x_2,y_2-1,z_2-1))./sqrt(2);
